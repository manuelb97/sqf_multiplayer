...
missionNamespace setVariable ["DefenceCenter", mapPos, true];

_marker = "training_end_" + (str random [11111, 55555, 99999]);
...
[
	format["New defence center set"], "center_top", 5, 0, 0, 100, "Green"
