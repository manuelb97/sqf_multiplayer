...
_coef = 100 / 75; // reach all items at 75% mission progress
_premiumItemPacks = _premiumItems select [0, round(_numPremiumItems * _progress * _coef)];
...
} forEach (_loadouts select [0, round(_numPremiumItems * _progress * _coef)]);