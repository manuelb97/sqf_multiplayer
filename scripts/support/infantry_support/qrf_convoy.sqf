...
while {speed _newvehicle > 10} do 
{
	uiSleep 1;
};

_disembarkers = (units _crewGrp) select {_x != gunner _newvehicle};
{
	_x moveOut _newvehicle;
	unassignVehicle _x;
} forEach _disembarkers;

_disembarkers allowGetIn false;
